...
module.exports = function words(language) {
    const possibleLanguages = ['american-english', 'brazilian', 'british-english', 'french', 'italian', 'ngerman', 'ogerman', 'portuguese', 'spanish', 'swiss', 'estonian', 'german', 'finnish', 'dutch'];
